...
public class MjpegInputStream extends DataInputStream {
    ...
    public static MjpegInputStream read (String url) throws ClientProtocolException,IOException{
        ...
        HttpConnectionParams.setConnectionTimeout(httpParams, Constant.CONNECTION_TIMEOUT_INT);
        HttpConnectionParams.setSoTimeout(httpParams, Constant.SO_TIMEOUT_INT);
